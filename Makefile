...
UNREALROOTPATH = /home/documents/Projets/UnrealEngine/UnrealEngine
GAMEPROJECTFILE =/home/perard/Documents/Projets/UnrealEngine/Wicked_Havens/Wicked_Havens.uproject
...
TARGETS = \
	...
	UnrealServer \
	Wicked_Havens-Linux-Debug  \
	Wicked_Havens-Linux-DebugGame  \
	Wicked_Havens-Linux-Test  \
	Wicked_Havens-Linux-Shipping  \
	Wicked_Havens \
	Wicked_HavensEditor-Linux-Debug  \
	Wicked_HavensEditor-Linux-DebugGame  \
	Wicked_HavensEditor-Linux-Test  \
	Wicked_HavensEditor-Linux-Shipping  \
	Wicked_HavensEditor\
	configure
...
Wicked_Havens-Linux-Debug:
	 $(PROJECTBUILD) Wicked_Havens Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Wicked_Havens-Linux-DebugGame:
	 $(PROJECTBUILD) Wicked_Havens Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Wicked_Havens-Linux-Test:
	 $(PROJECTBUILD) Wicked_Havens Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Wicked_Havens-Linux-Shipping:
	 $(PROJECTBUILD) Wicked_Havens Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Wicked_Havens:
	 $(PROJECTBUILD) Wicked_Havens Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

Wicked_HavensEditor-Linux-Debug:
	 $(PROJECTBUILD) Wicked_HavensEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Wicked_HavensEditor-Linux-DebugGame:
	 $(PROJECTBUILD) Wicked_HavensEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Wicked_HavensEditor-Linux-Test:
	 $(PROJECTBUILD) Wicked_HavensEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Wicked_HavensEditor-Linux-Shipping:
	 $(PROJECTBUILD) Wicked_HavensEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Wicked_HavensEditor:
	 $(PROJECTBUILD) Wicked_HavensEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
