...
class WH_CAMERA_API AWHCameraPawn : public APawn
{
	GENERATED_BODY()

public:
	// Sets default values for this character's properties
	AWHCameraPawn(const FObjectInitializer & ObjectInitializer);
...
private:
	...
	class UWHCameraComponent* CameraComponent;
	 ...
	 */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Components", meta = (AllowPrivateAccess))
	class UWHCameraMovementComponent* MovementComponent;

	/**
	 *	Mouse Component for this pawn
	 */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Components", meta = (AllowPrivateAccess))
	class UWHCameraMouseComponent* MouseComponent;
