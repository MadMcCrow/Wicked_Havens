...
UWHCameraMouseComponent::UWHCameraMouseComponent()
{
...
void UWHCameraMouseComponent::BeginPlay()
{
	Super::BeginPlay();
}
...
// Called every frame
void UWHCameraMouseComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
FVector2D UWHCameraMouseComponent::GetScreenRelativeMousePosition() const
{
...
void UWHCameraMouseComponent::UpdateMouseBorders()
{
...
FVector2D UWHCameraMouseComponent::GetBorderDirection() const
{
...
bool UWHCameraMouseComponent::IsInFocus() const
{
